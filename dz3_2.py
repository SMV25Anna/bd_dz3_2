...
class MainWindow(wx.Frame):
    ...
    def setUpMainWindow(self, panel, sizer):
        ...
        # Текст приветствия
        hello_label = wx.StaticText(panel, label="Привет Инноватика!")
        ...
        # Изображение
        image_path = r"C:\gitrep\bd\images\world.png"
...
class ProfileWindow(wx.Frame):
    ...
    def createImageLabels(self, panel, sizer):
        ...
        images = [
            r"C:\gitrep\bd\images\profile_image.png"
        ]
    ...
    def setUpMainWindow(self, panel, sizer):
        ...
        # Имя пользователя
        user_label = wx.StaticText(panel, label="Анна Чаречанская")
        ...
        languages_label = wx.StaticText(panel, label="Python | C# | MySQL ")
        ...
        developer_label = wx.StaticText(panel, label="Оператор 1С")
        sizer.Add(developer_label, 0, wx.LEFT | wx.TOP, 5)

        dev_dates_label = wx.StaticText(panel, label="Сентрябрь 2023 - настоящее время")
        ...
        developer_label = wx.StaticText(panel, label="Помощник экономиста")
        sizer.Add(developer_label, 0, wx.LEFT | wx.TOP, 5)

        dev_dates_label = wx.StaticText(panel, label="Июль 2021 - август 2024")
        date_font = wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL)
        dev_dates_label.SetFont(date_font)
        sizer.Add(dev_dates_label, 0, wx.LEFT | wx.TOP, 2)

        developer_label = wx.StaticText(panel, label="Репетитор по физике")
        sizer.Add(developer_label, 0, wx.LEFT | wx.TOP, 5)

        dev_dates_label = wx.StaticText(panel, label="Сентябрь 2025 - настоящее время")
        date_font = wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL)
        dev_dates_label.SetFont(date_font)
        sizer.Add(dev_dates_label, 0, wx.LEFT | wx.TOP, 2)
class App(wx.App):
